...
cat > /home/oracle/scripts/profile_${ORACLE_SID}.sh <<EOF
# Regular settings.
export TMP=/u01/tmp
export TMPDIR=\${TMP}
...
echo "******************************************************************************"
echo ". /home/oracle/scripts/profile_${ORACLE_SID}.sh" >> /home/oracle/.bash_profile


echo "******************************************************************************"
echo "Create start/stop scripts." `date`
echo "******************************************************************************"
. /home/oracle/scripts/profile_${ORACLE_SID}.sh
