...
su - oracle -c 'sh /nfsshare/vagrant-scripts/dataguard/ol7_112/node2/scripts/oracle_user_environment_setup.sh'
...
su - oracle -c 'sh /nfsshare/vagrant-scripts/dataguard/ol7_112/node2/scripts/oracle_create_database.sh'
